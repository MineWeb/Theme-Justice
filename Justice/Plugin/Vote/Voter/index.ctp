<div class="vote">
      ...
      <!-- Choose website -->
        ...
        <div class="panel panel-default panel-step step0">
          ...
          <div class="panel-heading">
            ...
            <h1 class="panel-title"><?= $Lang->get('VOTE__STEP_TITLE') ?> 0 : <?= $Lang->get('VOTE__STEP_0_TITLE') ?> <i style="display:none" class="glyphicon glyphicon-ok"></i></h1>
          ...
          <div class="panel-body">
            ...
            <?php foreach ($websites as $key => $value) { ?>
              ...
              <button class="btn btn-success choose_website btn-lg btn-block" id="<?= $key ?>"><?= $value['website_name'] ?></button>
      ...
      <!-- Choose username -->
        ...
        <div class="panel panel-default panel-step step1" style="opacity : 0.5;">
          ...
          <div class="panel-heading">
            ...
            <h1 class="panel-title"><?= $Lang->get('VOTE__STEP_TITLE') ?> 1 : <?= $Lang->get('USER__LOGIN') ?> <i style="display:none" id="icon_step1" class="glyphicon glyphicon-ok"></i></h1>
      ...
      <!-- Vote -->
        ...
        <div class="panel panel-default panel-step step2" style="opacity : 0.5;">
          ...
          <div class="panel-heading">
            ...
            <h1 class="panel-title"><?= $Lang->get('VOTE__STEP_TITLE') ?> 2 : <?= $Lang->get('VOTE__VOTE_ACTION') ?> <i style="display:none" id="icon_step2" class="glyphicon glyphicon-ok"></i></h1>
      ...
      <!-- Verification of OUT -->
        ...
        <div class="panel panel-default panel-step step3" style="display:none;opacity : 0.5;">
          ...
          <div class="panel-heading">
            ...
            <h1 class="panel-title"><?= $Lang->get('VOTE__STEP_TITLE') ?> 3 : <?= $Lang->get('VOTE__STEP_3_TITLE') ?> <span class="sec"></span><i style="display:none" id="icon_step3" class="glyphicon glyphicon-ok"></i></h1>
      ...
      <div class="panel panel-default panel-step step4" style="opacity : 0.5;">
        ...
        <div class="panel-heading">
          ...
          <h1 class="panel-title"><?= $Lang->get('VOTE__STEP_TITLE') ?> <span id="step4_title">3</span> : <?= $Lang->get('VOTE__REWARDS_TITLE') ?> <span class="sec"></span><i style="display:none" id="icon_step4" class="glyphicon glyphicon-ok"></i></h1>
        ...
        <div class="panel-body">
          ...
          <button class="btn btn-success btn-block btn-step4 disabled" disabled id="now"><?= $Lang->get('VOTE__STEP_4_REWARD_NOW') ?></button>

          <button class="btn btn-success btn-block btn-step4 disabled" disabled id="later"><?= $Lang->get('VOTE__STEP_4_REWARD_LATER') ?></button>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body vote">
      ...
      <?php if($Permissions->can('VOTE_SHOW_REWARDS')) { ?>
        ...
        <button data-toggle="modal" data-target="#rewards" class="btn btn-info btn-lg btn-block"><?= $Lang->get('VOTE__REWARDS_TITLE') ?></button>

      <?php } ?>

      <?php if($Permissions->can('VOTE_SHOW_RANKING')) { ?>

        <button data-toggle="modal" data-target="#ranking" class="btn btn-success btn-lg btn-block"><?= $Lang->get('VOTE__RANKING_TITLE') ?></button>
